...
class FlowchartSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.addText(text =>
				text.setValue(this.plugin.settings.config['font-size'].toString())
					.onChange(async (value) => {
		...
		new Setting(containerEl)
			...
			.addColorPicker(picker =>
				picker.setValue(this.plugin.settings.config['font-color'])
					.onChange(async (value) => {
		...
		new Setting(containerEl)
			...
			.addColorPicker(picker =>
				picker.setValue(this.plugin.settings.config['line-color'])
					.onChange(async (value) => {
		...
		new Setting(containerEl)
			...
			.addColorPicker(picker =>
				picker.setValue(this.plugin.settings.config['element-color'])
					.onChange(async (value) => {
		...
		new Setting(containerEl)
			...
			.addColorPicker(picker =>
				picker.setValue(this.plugin.settings.config['fill'])
					.onChange(async (value) => {
